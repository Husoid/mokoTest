...
kotlin {
    ...
    listOf(
        ...
        iosTarget.binaries.framework {
            baseName = "ComposeApp"
            isStatic = true
            export(project(":module:umbrellaKodein"))
            export(project(":module:core"))
        }
    }
    ...
    sourceSets {
        ...
        commonMain.dependencies {
            ...
            api(project(":module:umbrellaKodein"))
...
android {
    namespace = "com.tisonline.mobile"
    ...
    defaultConfig {
        applicationId = "com.tisonline.mobile"
